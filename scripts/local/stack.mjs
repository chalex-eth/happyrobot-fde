...
try {
  ...
  if (needsCheck) {
    ...
    for (const key of ['NGROK_AUTHTOKEN', 'MCP_AUTH_TOKEN', 'HAPPYROBOT_API_KEY', 'HAPPYROBOT_WORKFLOW_ID', 'HAPPYROBOT_MCP_SERVER_NAME', 'OTP_HASH_SECRET', 'TWIN_API_KEY', 'TMS_HOST', 'TMS_PORT', 'TMS_TOKEN', 'FMCSA_API_KEY', 'OPERATOR_PASSWORD', 'OPERATOR_SESSION_SECRET']) {
