...
- Twin forward migration: `docs/twin-m3.6.sql`, validated on fresh disposable PostgreSQL and applied once to shared Twin. Historical call events remain preserved.
