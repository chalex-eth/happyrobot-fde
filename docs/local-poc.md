...
| M4 — booking | Real TCP booking command and explicit uncertain-outcome handling | Confirmed reference before success; no automatic retry after ambiguous send; mocked senior-rep handoff | Pending |
