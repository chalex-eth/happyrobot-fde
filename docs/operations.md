...
1. Existing M3 through M4.2 migrations must already be installed. Apply
   `apps/api/db/tests/fixtures/legacy/twin-m5.sql`, then `apps/api/db/tests/fixtures/legacy/twin-m5.1.sql`, **once**. It is additive and preserves existing calls/events.
